(self["webpackChunkaerowork"] = self["webpackChunkaerowork"] || []).push([["node_modules_ionic_core_dist_esm_input-shims-73f15161_js"],{
...
var enableHideCaretOnScroll = function enableHideCaretOnScroll(componentEl, inputEl, scrollEl) {
  ...
  (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.a)(scrollEl, 'ionScrollStart', hideCaret);
  (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.a)(scrollEl, 'ionScrollEnd', showCaret);
  inputEl.addEventListener('blur', onBlur);
  return function () {
    (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.b)(scrollEl, 'ionScrollStart', hideCaret);
    (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.b)(scrollEl, 'ionScrollEnd', showCaret);
...
var enableInputBlurring = function enableInputBlurring() {
  ...
  (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.a)(doc, 'ionScrollStart', onScroll);
  doc.addEventListener('focusin', onFocusin, true);
  doc.addEventListener('touchend', onTouchend, false);
  return function () {
    (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.b)(doc, 'ionScrollStart', onScroll, true);
...
var enableScrollAssist = function enableScrollAssist(componentEl, inputEl, contentEl, footerEl, keyboardHeight) {
  ...
  var touchStart = function touchStart(ev) {
    coord = (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.p)(ev);
  };
  ...
  var touchEnd = function touchEnd(ev) {
    ...
    var endCoord = (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.p)(ev); // focus this input if the pointer hasn't moved XX pixels
...
var jsSetFocus = /*#__PURE__*/function () {
  var _ref = (0,D_Taylor_Documents_Websites_fuelit_fuelit_aeroworks_new_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)( /*#__PURE__*/D_Taylor_Documents_Websites_fuelit_fuelit_aeroworks_new_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2(componentEl, inputEl, contentEl, footerEl, keyboardHeight) {
    ...
    return D_Taylor_Documents_Websites_fuelit_fuelit_aeroworks_new_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            scrollContent = /*#__PURE__*/function () {
              var _ref2 = (0,D_Taylor_Documents_Websites_fuelit_fuelit_aeroworks_new_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)( /*#__PURE__*/D_Taylor_Documents_Websites_fuelit_fuelit_aeroworks_new_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {
...
var startInputShims = function startInputShims(config) {
  ...
  var registerInput = /*#__PURE__*/function () {
    var _ref3 = (0,D_Taylor_Documents_Websites_fuelit_fuelit_aeroworks_new_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)( /*#__PURE__*/D_Taylor_Documents_Websites_fuelit_fuelit_aeroworks_new_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee3(componentEl) {
      var inputRoot, inputEl, scrollEl, footerEl, rmFn, _rmFn;

      return D_Taylor_Documents_Websites_fuelit_fuelit_aeroworks_new_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return new Promise(function (resolve) {
                return (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.c)(componentEl, resolve);
              });
